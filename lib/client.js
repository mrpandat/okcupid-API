...
OKCupid.prototype.loginv2 = function(username, password, callback){
    var login_form = {
        "operationName":"authUserLoginWithEmail",
        "query":"mutation authUserLoginWithEmail($input: AuthUserLoginWithEmailInput!) {\n  authUserLoginWithEmail(input: $input) {\n    userid\n    statusCode\n    reenableAuthCode\n    reenableUserid\n    onboardingIncomplete\n    __typename\n  }\n}\n",
        "variables":{
            "input":{
                "deviceId":"5b862bda5a2a3018e8409dd33aad7c38",
                "email": username,
                password,
                "forceCaptcha":false,
            }
    ...
    this.requester.postRequest(URLS.graphql, login_form, function(err, res, body) {
      // if there is a non-zero status in response and response does not show an error
      if (!err && body.status !== 0) {
        err = {
          status: body.status, // a status number
